...
public class DatabaseInit implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        if (clientes.isEmpty()) {
            clienteRepository
                    .save(new Cliente("12345678", "Juan Pablo C", "juanbap@example.com", "1234567890", "password"));
            clienteRepository.save(new Cliente("87654321", "Jane Doe", "4aB4y@example.com", "9876543210", "password"));
            clienteRepository
                    .save(new Cliente("11111111", "Alice Smith", "sHwHt@example.com", "1111111111", "password"));
            clienteRepository
                    .save(new Cliente("22222222", "Bob Johnson", "wWw0l@example.com", "2222222222", "password"));
            clienteRepository
                    .save(new Cliente("33333333", "Eva Williams", "2TlP2@example.com", "3333333333", "password"));
            clienteRepository
                    .save(new Cliente("44444444", "Michael Brown", "aWw3G@example.com", "4444444444", "password"));
            clienteRepository
                    .save(new Cliente("55555555", "Sophia Davis", "www@example.com", "5555555555", "password"));
            clienteRepository
                    .save(new Cliente("66666666", "William Wilson", "3aB4y@example.com", "6666666666", "password"));
            clienteRepository
                    .save(new Cliente("77777777", "Olivia Taylor", "eg2TlP2@example.com", "7777777777", "password"));
            clienteRepository
                    .save(new Cliente("88888888", "James Anderson", "rwWw0l@example.com", "8888888888", "password"));
            clienteRepository
                    .save(new Cliente("99999999", "Emma Thomas", "eeg2TlP2@example.com", "9999999999", "password"));
            clienteRepository.save(new Cliente("00000000", "Noah Martinez", "g@example.com", "0000000000", "password"));
            clienteRepository.save(
                    new Cliente("10101010", "Isabella Hernandez", "r3aB4y@example.com", "1010101010", "password"));
            clienteRepository
                    .save(new Cliente("20202020", "Liam Clark", "peg2TlP2@example.com", "2020202020", "password"));
            clienteRepository
                    .save(new Cliente("30303030", "Ava Lewis", "oeg2TlP2@example.com", "3030303030", "password"));
            clienteRepository
                    .save(new Cliente("40404040", "Mason Walker", "poeg2TlP2@example.com", "4040404040", "password"));
            clienteRepository
                    .save(new Cliente("50505050", "Sophia Hall", "k3aB4y@example.com", "5050505050", "password"));
            clienteRepository
                    .save(new Cliente("60606060", "Ethan Young", "mnoeg2TlP2@example.com", "6060606060", "password"));
            clienteRepository
                    .save(new Cliente("70707070", "Emma Scott", "rr3aB4y@example.com", "7070707070", "password"));
            clienteRepository
                    .save(new Cliente("80808080", "Noah Green", "gfoeg2TlP2@example.com", "8080808080", "password"));
            clienteRepository
                    .save(new Cliente("90909090", "Isabella Adams", "lkmnoe@example.com", "9090909090", "password"));
            clienteRepository
                    .save(new Cliente("01010101", "Liam Baker", "vfoeg2TlP2@example.com", "0101010101", "password"));
            clienteRepository.save(new Cliente("11111111", "Ava Hill", "vedfrg@example.com", "1111111111", "password"));
            clienteRepository
                    .save(new Cliente("22222222", "Noah Wilson", "vgrtvfs@example.com", "2222222222", "password"));
            clienteRepository
                    .save(new Cliente("33333333", "Sophia Davis", "jyhgt@example.com", "3333333333", "password"));
            clienteRepository
                    .save(new Cliente("44444444", "William Taylor", "wrbrtfb@example.com", "4444444444", "password"));
            clienteRepository
                    .save(new Cliente("55555555", "Olivia Anderson", "grsrgv@example.com", "5555555555", "password"));
            clienteRepository
                    .save(new Cliente("66666666", "James Thomas", "aqefdfc@example.com", "6666666666", "password"));
            clienteRepository
                    .save(new Cliente("77777777", "Emma Martinez", "kiujy@example.com", "7777777777", "password"));
            clienteRepository
                    .save(new Cliente("88888888", "Noah Hernandez", "btgd@example.com", "8888888888", "password"));
            clienteRepository
                    .save(new Cliente("99999999", "Isabella Clark", "wrt5hth@example.com", "9999999999", "password"));
            clienteRepository
                    .save(new Cliente("00000000", "Mason Lewis", "wwwrgfb@example.com", "0000000000", "password"));
            clienteRepository
                    .save(new Cliente("00000000", "Liam Lewis", "lkmlbg@example.com", "0000000000", "password"));
            clienteRepository
                    .save(new Cliente("10101010", "Ava Walker", "amfde@example.com", "1010101010", "password"));
            clienteRepository
                    .save(new Cliente("20202020", "Noah Hall", "alkmfog@example.com", "2020202020", "password"));
            clienteRepository
                    .save(new Cliente("30303030", "Sophia Young", "brmergk4@example.com", "3030303030", "password"));
            clienteRepository
                    .save(new Cliente("40404040", "Ethan Scott", "g4joer4g@example.com", "4040404040", "password"));
            clienteRepository
                    .save(new Cliente("50505050", "Emma Green", "jgi4ogmr@example.com", "5050505050", "password"));
            clienteRepository.save(new Cliente("60606060", "Noah Adams", "brm4@example.com", "6060606060", "password"));
            clienteRepository
                    .save(new Cliente("70707070", "Isabella Baker", "3opkmgw@example.com", "7070707070", "password"));
            clienteRepository
                    .save(new Cliente("80808080", "Liam Hill", "o90jfgke@example.com", "8080808080", "password"));
            clienteRepository
                    .save(new Cliente("90909090", "Ava Wilson", "34jmfe3w@example.com", "9090909090", "password"));
            clienteRepository
                    .save(new Cliente("01010101", "Noah Davis", "3o4pj3@example.com", "0101010101", "password"));
            clienteRepository
                    .save(new Cliente("11111111", "Sophia Taylor", "fe34f@example.com", "1111111111", "password"));
            clienteRepository
                    .save(new Cliente("22222222", "Ethan Anderson", "g4bw4q@example.com", "2222222222", "password"));
            clienteRepository
                    .save(new Cliente("33333333", "Emma Thomas", "b4bw45gew@example.com", "3333333333", "password"));
            clienteRepository
                    .save(new Cliente("44444444", "Noah Martinez", "q4hgq4hq@example.com", "4444444444", "password"));
            clienteRepository.save(
                    new Cliente("55555555", "Isabella Hernandez", "q4gbnts@example.com", "5555555555", "password"));
            clienteRepository
                    .save(new Cliente("66666666", "Liam Clark", "d7Cw3@example.com", "6666666666", "password"));
        ...
        mascotaRepository.save(
                new Mascota("Toby", "Bulldog", 2, 15, "Alergia", imageUrls[random.nextInt(imageUrls.length)], true));
        mascotaRepository.save(
                new Mascota("Luna", "Poodle", 4, 10, "Alergia", imageUrls[random.nextInt(imageUrls.length)], true));
        mascotaRepository.save(new Mascota("Max", "Golden Retriever", 6, 30, "Alergia",
                imageUrls[random.nextInt(imageUrls.length)], true));
        mascotaRepository.save(
                new Mascota("Bella", "Chihuahua", 1, 5, "Alergia", imageUrls[random.nextInt(imageUrls.length)], true));
        mascotaRepository.save(
                new Mascota("Trosky", "Pitbull", 7, 35, "Alergia", imageUrls[random.nextInt(imageUrls.length)], true));
        mascotaRepository.save(
                new Mascota("Daisy", "Dalmata", 8, 40, "Alergia", imageUrls[random.nextInt(imageUrls.length)], true));
        mascotaRepository.save(
                new Mascota("Coco", "Beagle", 9, 45, "Alergia", imageUrls[random.nextInt(imageUrls.length)], true));
        mascotaRepository.save(
                new Mascota("Lola", "Husky", 10, 50, "Alergia", imageUrls[random.nextInt(imageUrls.length)], true));
        mascotaRepository.save(
                new Mascota("Lucy", "Pug", 11, 55, "Sobrepeso", imageUrls[random.nextInt(imageUrls.length)], true));
        ...
        mascotaRepository.save(new Mascota("Molly", "Doberman", 13, 65, "Sobrepeso",
                imageUrls[random.nextInt(imageUrls.length)], true));
        mascotaRepository.save(
                new Mascota("Sadie", "Boxer", 14, 70, "Sobrepeso", imageUrls[random.nextInt(imageUrls.length)], true));
        ...
        mascotaRepository.save(new Mascota("Shadow", "Bulldog", 17, 85, "Sobrepeso",
                imageUrls[random.nextInt(imageUrls.length)], true));
        mascotaRepository.save(
                new Mascota("Lucky", "Poodle", 18, 90, "Sobrepeso", imageUrls[random.nextInt(imageUrls.length)], true));
        ...
        mascotaRepository.save(new Mascota("Bentley", "Beagle", 23, 115, "Sobrepeso",
                imageUrls[random.nextInt(imageUrls.length)], true));
        mascotaRepository.save(
                new Mascota("Luna", "Husky", 24, 120, "Sobrepeso", imageUrls[random.nextInt(imageUrls.length)], true));
        mascotaRepository.save(
                new Mascota("Riley", "Pug", 25, 125, "Sobrepeso", imageUrls[random.nextInt(imageUrls.length)], true));
        ...
        mascotaRepository.save(new Mascota("Rocky", "Doberman", 27, 135, "Sobrepeso",
                imageUrls[random.nextInt(imageUrls.length)], true));
        mascotaRepository.save(
                new Mascota("Daisy", "Boxer", 28, 140, "Sobrepeso", imageUrls[random.nextInt(imageUrls.length)], true));
        ...
        mascotaRepository.save(new Mascota("Lucy", "Bulldog", 31, 155, "Sobrepeso",
                imageUrls[random.nextInt(imageUrls.length)], true));
        mascotaRepository.save(
                new Mascota("Bailey", "Poodle", 32, 160, "Fiebre", imageUrls[random.nextInt(imageUrls.length)], true));
        ...
        mascotaRepository.save(new Mascota("Sadie", "Chihuahua", 34, 170, "Fiebre",
                imageUrls[random.nextInt(imageUrls.length)], true));
        mascotaRepository.save(
                new Mascota("Duke", "Pitbull", 35, 175, "Fiebre", imageUrls[random.nextInt(imageUrls.length)], true));
        mascotaRepository.save(
                new Mascota("Bear", "Dalmata", 36, 180, "Fiebre", imageUrls[random.nextInt(imageUrls.length)], true));
        mascotaRepository.save(
                new Mascota("Shadow", "Beagle", 37, 185, "Fiebre", imageUrls[random.nextInt(imageUrls.length)], true));
        mascotaRepository.save(
                new Mascota("Lucky", "Husky", 38, 190, "Fiebre", imageUrls[random.nextInt(imageUrls.length)], true));
        mascotaRepository
                .save(new Mascota("Milo", "Pug", 39, 195, "Fiebre", imageUrls[random.nextInt(imageUrls.length)], true));
        ...
        mascotaRepository.save(new Mascota("Scooby", "Doberman", 41, 205, "Fiebre",
                imageUrls[random.nextInt(imageUrls.length)], true));
        mascotaRepository.save(
                new Mascota("Lassie", "Boxer", 42, 210, "Fiebre", imageUrls[random.nextInt(imageUrls.length)], true));
        ...
        mascotaRepository.save(new Mascota("Luna", "Great Dane", 44, 220, "Fiebre",
                imageUrls[random.nextInt(imageUrls.length)], true));
        mascotaRepository.save(
                new Mascota("Rambo", "Bulldog", 45, 225, "Fiebre", imageUrls[random.nextInt(imageUrls.length)], true));
        mascotaRepository.save(
                new Mascota("Rex", "Poodle", 46, 230, "Fiebre", imageUrls[random.nextInt(imageUrls.length)], true));
        mascotaRepository.save(new Mascota("Toby", "Golden Retriever", 47, 235, "Fiebre",
                imageUrls[random.nextInt(imageUrls.length)], true));
        mascotaRepository.save(
                new Mascota("Max", "Chihuahua", 48, 240, "Fiebre", imageUrls[random.nextInt(imageUrls.length)], true));
        mascotaRepository.save(
                new Mascota("Loki", "Pitbull", 49, 245, "Fiebre", imageUrls[random.nextInt(imageUrls.length)], true));
        mascotaRepository.save(
                new Mascota("Koda", "Dalmata", 50, 250, "Fiebre", imageUrls[random.nextInt(imageUrls.length)], true));
        mascotaRepository.save(
                new Mascota("Wally", "Beagle", 51, 255, "Fiebre", imageUrls[random.nextInt(imageUrls.length)], true));
        mascotaRepository.save(
                new Mascota("Rusty", "Husky", 52, 260, "Fiebre", imageUrls[random.nextInt(imageUrls.length)], true));
        mascotaRepository.save(
                new Mascota("Buster", "Pug", 53, 265, "Fiebre", imageUrls[random.nextInt(imageUrls.length)], true));
        ...
        mascotaRepository.save(new Mascota("Mocha", "Husky", 66, 330, "Ingestión",
                imageUrls[random.nextInt(imageUrls.length)], true));
        mascotaRepository.save(
                new Mascota("Minnie", "Pug", 67, 335, "Ingestión", imageUrls[random.nextInt(imageUrls.length)], true));
        ...
        mascotaRepository.save(new Mascota("Blossom", "Husky", 80, 400, "Ingestión",
                imageUrls[random.nextInt(imageUrls.length)], true));
        mascotaRepository.save(
                new Mascota("Bolt", "Pug", 81, 405, "Congestión", imageUrls[random.nextInt(imageUrls.length)], true));
        ...
        mascotaRepository.save(new Mascota("Callie", "Beagle", 93, 465, "Moquillo",
                imageUrls[random.nextInt(imageUrls.length)], true));
        mascotaRepository.save(
                new Mascota("Candy", "Husky", 94, 470, "Moquillo", imageUrls[random.nextInt(imageUrls.length)], true));
        mascotaRepository.save(
                new Mascota("Carmen", "Pug", 95, 475, "Moquillo", imageUrls[random.nextInt(imageUrls.length)], true));
        ...
        mascotaRepository.save(new Mascota("Cayla", "Doberman", 97, 485, "Moquillo",
                imageUrls[random.nextInt(imageUrls.length)], true));
        mascotaRepository.save(
                new Mascota("Cecily", "Boxer", 98, 490, "Moquillo", imageUrls[random.nextInt(imageUrls.length)], true));
        ...
        mascotaRepository.save(new Mascota("Cleo", "Bulldog", 101, 505, "Moquillo",
                imageUrls[random.nextInt(imageUrls.length)], true));
        mascotaRepository.save(
                new Mascota("Cora", "Poodle", 102, 510, "Moquillo", imageUrls[random.nextInt(imageUrls.length)], true));
        ...
        mascotaRepository.save(new Mascota("Dakota", "Husky", 108, 540, "Moquillo",
                imageUrls[random.nextInt(imageUrls.length)], true));
        mascotaRepository.save(
                new Mascota("Daphne", "Pug", 109, 545, "Moquillo", imageUrls[random.nextInt(imageUrls.length)], true));
        ...
        if (veterinarios.isEmpty()) {
            ...
            veterinarioRepository.save(new Veterinario("VET78901", "Dr. Jorge Sanchez", "Pediatría",
                    "https://veterinary.stmatthews.edu/uploads/sites/8/2020/09/smu-1187228710.webp?w=776", 9,
                    "password"));
            veterinarioRepository.save(new Veterinario("VET89012", "Dra. Patricia Ramirez", "Radiología",
                    "https://res.cloudinary.com/hnpb47ejt/image/upload/v1646258562/lead-gen/veterinary-technician", 20,
                    "password"));
            ...
            veterinarioRepository.save(new Veterinario("VET01234", "Dra. Sofia Morales", "Cirugía",
                    "https://www.aaha.org/wp-content/uploads/2024/03/49350d8880e24a9bb91bfcb4df6c4598.jpg", 8,
                    "password"));
        ...
        if (tratamientos.isEmpty()) {
            // Obtener todas las mascotas ya creadas
            List<Mascota> mascotasDisponibles = mascotaRepository.findAll();

            // Crear 10 tratamientos de ejemplo
            if (!mascotasDisponibles.isEmpty() && !veterinarios.isEmpty()) {
                // Definir drogas comunes para tratamientos veterinarios
                String[][] drogasInfo = {
                    // nombre, precioCompra, precioVenta, unidadesDisponibles
                    {"Amoxicilina", "15.50", "25.00", "100"},
                    {"Cefalexina", "22.75", "35.50", "85"},
                    {"Metronidazol", "18.25", "28.99", "120"},
                    {"Prednisona", "12.99", "21.50", "150"},
                    {"Meloxicam", "28.50", "42.75", "90"},
                    {"Tramadol", "32.25", "48.50", "75"},
                    {"Dipirona", "10.80", "18.99", "200"},
                    {"Doxiciclina", "25.45", "38.75", "110"},
                    {"Enrofloxacina", "35.99", "52.25", "65"},
                    {"Carprofeno", "40.25", "59.99", "80"},
                    {"Ivermectina", "22.50", "36.75", "95"},
                    {"Fluconazol", "29.99", "45.50", "70"}
                };
                ...
                for (int i = 0; i < 10; i++) {
                    // Seleccionar mascota y veterinario aleatoriamente
                    Mascota mascota = mascotasDisponibles.get(random3.nextInt(mascotasDisponibles.size()));
                    Veterinario veterinario = veterinarios.get(random3.nextInt(veterinarios.size()));

                    // Generar fecha aleatoria en los últimos 6 meses
                    calendar.setTime(new Date());
                    calendar.add(Calendar.MONTH, -random3.nextInt(6));
                    calendar.add(Calendar.DAY_OF_MONTH, -random3.nextInt(30));
                    ...
                    // Guardar tratamiento para obtener su ID
                    tratamientoRepository.save(tratamiento);

                    // Crear exactamente 3 drogas para cada tratamiento
                    List<Droga> drogas = new ArrayList<>();
                    
                    // Seleccionar 3 drogas distintas aleatoriamente para este tratamiento
                    int[] drogasIndices = new int[3];
                    for (int j = 0; j < 3; j++) {
                        int indice;
                        boolean repetido;
                        do {
                            repetido = false;
                            indice = random3.nextInt(drogasInfo.length);
                            
                            for (int k = 0; k < j; k++) {
                                if (drogasIndices[k] == indice) {
                                    repetido = true;
                                    break;
                                }
                            }
                        ...
                        drogasIndices[j] = indice;
                        
                        // Crear la droga con la información correspondiente
                        Droga droga = new Droga();
                        droga.setNombre(drogasInfo[indice][0]);
                        droga.setPrecioCompra(Float.parseFloat(drogasInfo[indice][1]));
                        droga.setPrecioVenta(Float.parseFloat(drogasInfo[indice][2]));
                        
                        // Para unidades disponibles, usar un valor aleatorio entre 10 y 100
                        int unidadesDisponibles = random3.nextInt(91) + 10; // Genera entre 10 y 100
                        droga.setUnidadesDisponibles(unidadesDisponibles);
                        
                        // Para unidades vendidas, usar un valor aleatorio entre 1 y 50
                        int unidadesVendidas = random3.nextInt(50) + 1;
                    ...
                    // Actualizar el contador de atenciones del veterinario
                    veterinario.setNumAtenciones(veterinario.getNumAtenciones() + 1);
                    veterinarioRepository.save(veterinario);

                    // Actualizar la lista de drogas en el tratamiento
